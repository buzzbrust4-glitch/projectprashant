...
tk.Button(btn_frame,text="Update Task",width=10,command=remove_task).grid(row=0,column=1,padx=5)
tk.Button(btn_frame,text="Exit",width=10,command=remove_task).grid(row=0,column=1,padx=5)
